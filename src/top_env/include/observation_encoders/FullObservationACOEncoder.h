...
class FullObservationACOEncoder : public ObservationEncoder{
public:
    FullObservationACOEncoder(Graph& graph, int number_of_resources, int number_of_actions, Config config);
