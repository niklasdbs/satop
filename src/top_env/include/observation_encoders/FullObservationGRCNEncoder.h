...
class FullObservationGRCNEncoder : public ObservationEncoder{
public:
    FullObservationGRCNEncoder(Graph& graph, int number_of_resources, int number_of_actions, Config config);
